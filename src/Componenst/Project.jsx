          ...
          {projects.map((project, index) => (
            <SwiperSlide key={index}>
              <div className="relative group overflow-hidden rounded-none md:rounded-2xl shadow-xl cursor-pointer w-full mx-auto bg-black">
                ...
                />
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center opacity-0 group-hover:opacity-100 transition-all duration-500 bg-black/50">
                  <h2 className="text-[42px] md:text-[56px] text-white bg-[#FE8425] font-bebas mb-3 px-4 py-1 rounded-md shadow-md transform rotate-3 group-hover:-rotate-3 group-hover:scale-110 transition-all">
                    {project.title}
                  </h2>
